        ...
        while (moreWhiteSpace) {
            ...
            if (ch == '/') {
                ...
                if (ch == '/') {
                    ...
                    // looking for the start of multi line comments
                    while (true) {
                        nextCh();
                        if (ch == '*') {
                            //looking for a star in case of terminating the multiline comment.
                            nextCh();
                            if (ch == '/') {
                                /* If a slash comes after a star, then it ends the multiline 
                                 comment. */
                                nextCh();
                                break;
                            }
        ...
        switch (ch) {
            ...
            case '.':
                ...
                if (isDigit(ch) == true) {
                    buffer.append(ch);
                    nextCh();
                    while ( ch != '\n' && ch != EOFCH && ch != '*' && ch != '/' && ch != ')' && (isWhitespace(ch) != true) && ch != ';') {
                        buffer.append(ch);
                        nextCh();
                    }
            ...
            case '>':
                ...
                if (ch == '>') {
                    ...
                    if (ch == '>') {
                        nextCh();
                        if (ch == '=') {
                            // looking for >>>= for LRSHIFT ASSIGN
                            nextCh();
                        ...
                        // looking for >>= for ARSHIFT ASSIGN
                        nextCh();
