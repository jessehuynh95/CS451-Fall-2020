...
class JMultiplyOp extends JBinaryExpression {
    ...
    public void codegen(CLEmitter output) {
        //modified to support long and double
        if (type == Type.INT){
            lhs.codegen(output);
            rhs.codegen(output);
...
class JOrOp extends JBinaryExpression {
    /**
     * Constructs an AST for an Or expression.
     *
    ...
    public JExpression analyze(Context context) {
        lhs = (JExpression) lhs.analyze(context);
        rhs = (JExpression) rhs.analyze(context);
        //MODIFIED TO ADD SUPPORT FOR LONG
        if (lhs.type() == Type.INT && rhs.type() == Type.INT) {
            type = Type.INT;
        } else if (lhs.type() == Type.LONG && rhs.type() == Type.LONG) {
            type = Type.LONG;
...
class JXorOp extends JBinaryExpression {
    /**
     * Constructs an AST for an Exclusive Or expression.
     *
...
class JAndOp extends JBinaryExpression {
    /**
     * Constructs an AST for an And expression.
     *
...
class JALeftShiftOp extends JBinaryExpression {
    /**
     * Constructs an AST for an arithmetic left shift expression.
     *
...
class JARightShiftOp extends JBinaryExpression {
    /**
     * Constructs an AST for an arithmetic right shift expression.
     *
...
class JLRightShiftOp extends JBinaryExpression {
    /**
     * Constructs an AST for a logical right shift expression.
     *
