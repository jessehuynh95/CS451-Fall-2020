...
enum TokenKind {
    ...
    // Operators.
    ALSHIFT("<<"), ALSHIFT_ASSIGN("<<="), AND("&"),
    AND_ASSIGN("&="), ARSHIFT(">>"), ARSHIFT_ASSIGN(">>="), ASSIGN("="),
    COLON(":"), DEC("--"), DIV("/"), DIV_ASSIGN("/="), EQUAL("=="), GE(">="),
    GT(">"), INC("++"), LAND("&&"), LE("<="),
    LNOT("!"), LOR("||"), LRSHIFT(">>>"), LRSHIFT_ASSIGN(">>>="),
    LT("<"), MINUS("-"), MINUS_ASSIGN("-="), NOT("~"),
    NOT_EQUAL("!="), OR("|"), OR_ASSIGN("|="),  PLUS("+"), PLUS_ASSIGN("+="),
    QUESTION("?"), REM("%"), REM_ASSIGN("%="), STAR("*"), STAR_ASSIGN("*="), XOR("^"),
    XOR_ASSIGN("^="),
    ...
    INT_LITERAL("<INT_LITERAL>"), LONG_LITERAL("<LONG_LITERAL>"), DOUBLE_LITERAL(
            "<DOUBLE_LITERAL>"),
